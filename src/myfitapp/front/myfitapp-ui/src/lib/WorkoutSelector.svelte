...
<div
  class="workout-selector bg-white dark:bg-gray-800 shadow-md rounded-lg p-6"
>
  <div class="flex flex-col space-y-4">
    <div class="flex justify-between items-center">
      {#if !showWorkouts && selectedWorkout}
        <button
          type="button"
          class="text-blue-600 hover:text-blue-800 focus:outline-none focus:underline transition duration-300 ease-in-out"
      ...
      <div class="flex-grow">
          ...
          <div class="flex flex-wrap gap-2">
            {#each workouts as workout (workout)}
              <div class="flex items-center">
                <button
                  type="button"
                  class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg shadow-md transition duration-300 ease-in-out"
        ...
        {:else}
          <p>No schedas available for this workout.</p>
        {/if}
      </div>

      <button
        type="button"
        class="px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-white font-bold rounded-lg shadow-md transition duration-300 ease-in-out"
